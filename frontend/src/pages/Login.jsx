  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans relative overflow-hidden">
      ...
      <div className="relative bg-gradient-to-br from-[#064E3B] via-[#047857] to-[#10B981] pt-20 pb-28 px-6 text-center text-white overflow-hidden">
        ...
        <div className="absolute bottom-[-10%] left-[-10%] w-48 h-48 bg-emerald-400/20 rounded-full blur-2xl pointer-events-none"></div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="text-right mt-2">
                <button type="button" className="text-xs text-emerald-600 font-bold hover:text-emerald-800 transition-colors">
                  Lupa password?
                </button>
              </div>
            </div>
            ...
            <div className="pt-2">
              ...
              >
                {loading ? (
                  <>
                    <Loader2 size={18} className="animate-spin" /> Memeriksa Data...
                  </>
                ) : (
                  'Masuk Sekarang'
                )}
