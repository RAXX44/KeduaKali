...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.message || 'Gagal masuk. Silakan periksa kembali email & password kamu.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans relative overflow-hidden">
      ...
      <div className="relative bg-gradient-to-br from-[#064E3B] via-[#047857] to-[#10B981] pt-20 pb-28 px-6 text-center text-white overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center">
          {/* ✅ BERSIDARI LEAF: Menggunakan logo1 dengan wrapper persis Register/AdminLayout */}
          ...
          <h1 className="text-3xl font-black tracking-tight mb-1">KeduaKali</h1>
          <p className="text-sm text-emerald-100 font-medium max-w-xs leading-relaxed">
            Selamatkan makanan, lindungi bumi, mulai dari langkah kecilmu.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 w-full max-w-md mx-auto px-5 relative z-20 -mt-16 pb-10">
        <div className="bg-white rounded-[2rem] shadow-[0_15px_40px_rgba(0,0,0,0.08)] border border-gray-100 p-6 md:p-8">
          ...
          <div className="mb-6">
            <h2 className="text-xl font-black text-gray-900 tracking-tight">Selamat Datang Kembali!</h2>
            <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mt-1">Masuk untuk melanjutkan</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Input Email */}
            <div>
              <label className="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1.5 ml-1">Email Anda</label>
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5 ml-1">
                ...
                <Link to="#" className="text-[11px] font-bold text-emerald-600 hover:text-emerald-800 transition-colors">Lupa Kata Sandi?</Link>
              </div>
              <div className="relative group">
            ...
            <div className="pt-2">
              ...
              >
                {loading ? (
                  <>
                    <Loader2 size={18} className="animate-spin" /> Membuka Akses...
                  </>
                ) : (
                  'Masuk ke Aplikasi'
                )}
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Atau masuk dengan</span>
            <div className="flex-1 h-px bg-gray-100"></div>
          </div>
          ...
          <button
            ...
            className="w-full bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-bold py-3.5 rounded-2xl text-sm flex items-center justify-center gap-3 transition-all shadow-sm active:scale-95"
          >
            {googleLoading ? (
